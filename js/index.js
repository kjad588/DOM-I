...
const mainTextHeadings = document.querySelectorAll('.main-content h4');

mainTextHeadings[0].textContent = 'FEATURES';
mainTextHeadings[1].textContent = 'ABOUT';
mainTextHeadings[2].textContent = 'SERVICES';
mainTextHeadings[3].textContent = 'PRODUCT';
mainTextHeadings[4].textContent = 'VISION';
...
const textImg = document.querySelector('#middle-img');
textImg.src = 'img/mid-page-accent.jpg';
